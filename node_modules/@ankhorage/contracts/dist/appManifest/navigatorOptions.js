import { DRAWER_POSITIONS, DRAWER_TYPES, FIXED_HEADLESS_TABS_PRESENTATIONS, HEADLESS_TABS_PRESENTATIONS, JAVASCRIPT_STACK_PRESENTATIONS, JAVASCRIPT_TABS_PRESENTATIONS, NATIVE_TABS_MINIMIZE_BEHAVIORS, STACK_PRESENTATIONS, } from '../navigator';
...
export function isTabsImplementationConfig(value) {
    ...
    return (value.implementation === 'headless' &&
...
function isHeadlessTabsWebConfig(value) {
    return (isRecord(value) &&
...
function isHeadlessTabsPresentationConfig(value) {
