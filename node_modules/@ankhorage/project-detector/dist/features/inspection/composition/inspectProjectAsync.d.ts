 ...
 * @readme
 */
export declare function inspectProjectAsync(path: string, options?: ProjectInspectionOptions): Promise<ProjectInspection>;
//# sourceMappingURL=inspectProjectAsync.d.ts.map