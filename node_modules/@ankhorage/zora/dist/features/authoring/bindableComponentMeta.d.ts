export declare const ZORA_BINDABLE_COMPONENT_META: {
    ...
    readonly Image: {
        ...
        readonly props: {
            readonly fit: {
                ...
                readonly enum: readonly ["cover", "contain", "stretch", "repeat", "center", "none"];
            };
    ...
    readonly TextInput: {
        ...
        readonly category: "component";
        readonly description: "Captures a string value in single-line, multiline, or secure-entry modes.";
        readonly directManifestNode: true;
        readonly allowedChildren: readonly [];
        readonly bindings: {
            readonly props: {
                readonly value: {
                    ...
                    readonly description: "Current text input value.";
                    readonly value: {
                        readonly type: "string";
                    };
                    readonly acceptsFallback: true;
                ...
                readonly disabled: {
                    readonly label: "Disabled";
                    readonly description: "Whether the text input is disabled.";
                    readonly value: {
                        readonly type: "boolean";
                    };
                    readonly acceptsFallback: true;
            ...
            readonly events: {
                readonly changeText: {
                    ...
                    readonly payload: {
                        readonly eventType: "textInput.changeText";
                        readonly fields: readonly [{
                            readonly path: "value";
                            readonly type: "string";
                            readonly label: "Value";
        ...
        readonly bindings: {
            ...
            readonly events: {
                readonly checkedChange: {
                    ...
                    readonly description: "Runs when checked state changes.";
                    readonly payload: {
                        readonly eventType: "switch.checkedChange";
                        readonly fields: readonly [{
                            readonly path: "checked";
                            readonly type: "boolean";
                            readonly label: "Checked";
    ...
    readonly List: {
        ...
        readonly directManifestNode: true;
        readonly allowedChildren: readonly ["ListSection", "ListItem"];
        readonly bindings: {
            readonly props: {
                readonly items: {
